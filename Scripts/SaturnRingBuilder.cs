...
/// <summary>
/// Procedurally creates Saturn's ring as a flat torus mesh at runtime.
/// Attach this to the Saturn planet GameObject.
/// </summary>
...
public class SaturnRingBuilder : MonoBehaviour
{
    ...
    [Header("Material")]
    public Material ringMaterial;   // assign a semi-transparent yellowish material
    ...
    void BuildRing()
    {
        ...
        ring.transform.localRotation = Quaternion.Euler(10f, 0f, 0f); // slight tilt
